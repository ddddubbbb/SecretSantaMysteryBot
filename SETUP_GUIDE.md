...
2. **Все участники** автоматически регистрируются
3. **Участники** указывают желания через `/mygift`
4. **В назначенное время** происходит жеребьевка
5. **Участники получают** личные сообщения с информацией о получателе подарка
6. **Во время игры** можно угадывать личности через `/santabingo`
7. **В день раскрытия** показывается финальная таблица лидеров
